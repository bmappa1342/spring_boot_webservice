...
public class restTemplateController {
    private static final String GET_ALL_APP_USER_API="http://localhost:8081/AppUser/getAll";
    private static final String GET_ALL_APP_USER_ID_API="http://localhost:8081/AppUser/getAppUSer/{id}";
